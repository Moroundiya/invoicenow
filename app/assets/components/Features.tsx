			...
			<div className="lg:w-10/12 mx-auto h-full">
				...
				<div className="mt-12 grid grid-cols-3 gap-6">
					{features.map((feature) => (
						<div
							key={feature.title}
							className="w-full h-30 rounded-2xl bg-[#041f5049] border-2 border-[#041E50] p-3 flex space-x-3">
							...
							<div className="w-4/5">
								...
								<p className="text-[#eeeeee9e] text-sm mt-0 w-10/12 leading-tight font-light">
									{feature.description}
								</p>
							</div>
						</div>

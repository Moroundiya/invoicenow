		...
		<div className="flex w-full flex-col gap-3">
			<div className="flex w-full flex-col gap-3 sm:flex-row">
				...
				<button
					...
					className="inline-flex h-11 flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 px-5 text-sm font-semibold text-white shadow-[0_0_25px_rgba(0,119,255,0.18)] transition hover:from-blue-500 hover:to-cyan-500 disabled:pointer-events-none disabled:opacity-50">
					{isDownloading === "pdf" ? (
						<>
				...
				<button
					...
					onClick={downloadPNG}
					disabled={downloading}
					className="inline-flex h-11 flex-1 items-center justify-center gap-2 rounded-xl border border-blue-400/15 bg-blue-500/[0.05] px-5 text-sm font-semibold text-blue-400 transition hover:border-blue-400/25 hover:bg-blue-500/10 disabled:pointer-events-none disabled:opacity-50">
					{isDownloading === "png" ? (
						<>
